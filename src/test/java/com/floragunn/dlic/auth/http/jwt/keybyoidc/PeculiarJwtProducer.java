/**
 * Based on JwsCompactProducer from Apache CXF.
 * 
...
public class PeculiarJwtProducer extends AbstractJoseProducer {
    ...
    public String processJwt(JwtToken jwt, JweEncryptionProvider theEncProvider, JwsSignatureProvider theSigProvider) {
        ...
        if (isJwsRequired()) {
            ...
            JwsJwtCompactProducer jws = new PeculiarJwsJwtCompactProducer(jwt);
            if (jws.isPlainText()) {
    ...
    private static class PeculiarJwsJwtCompactProducer extends JwsJwtCompactProducer {

        public PeculiarJwsJwtCompactProducer(JwtToken token) {
            super(token, new PeculiarJsonMapObjectReaderWriter());
        }
    }

    private static class PeculiarJsonMapObjectReaderWriter extends JsonMapObjectReaderWriter {
