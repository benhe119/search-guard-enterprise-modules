...
public class RolesMappingApiTest extends AbstractRestApiUnitTest {
	...
	public void testRolesMappingApi() throws Exception {
		...
		Assert.assertEquals("starfleet", settings.getAsArray("sg_role_starfleet.backendroles")[0]);
		Assert.assertEquals("captains", settings.getAsArray("sg_role_starfleet.backendroles")[1]);
		Assert.assertEquals("*.starfleetintranet.com", settings.getAsArray("sg_role_starfleet.hosts")[0]);
		Assert.assertEquals("nagilum", settings.getAsArray("sg_role_starfleet.users")[0]);
