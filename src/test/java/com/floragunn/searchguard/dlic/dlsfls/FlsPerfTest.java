...
public class FlsPerfTest extends AbstractDlsFlsTest{
    ...
    public void testFlsPerfNamed() throws Exception {
        ...
        sw.start("with fls");
        Assert.assertEquals(HttpStatus.SC_OK, (res = rh.executeGetRequest("/deals/_search?pretty&size=1000", encodeBasicHeader("perf_named_only", "perf_named_only"))).getStatusCode());
        sw.stop();
    ...
    public void testFlsPerfWcEx() throws Exception {
        ...
        sw.start("with fls");
        Assert.assertEquals(HttpStatus.SC_OK, (res = rh.executeGetRequest("/deals/_search?pretty&size=1000", encodeBasicHeader("perf_wc_ex", "perf_wc_ex"))).getStatusCode());
        sw.stop();
        Assert.assertTrue(res.getBody().contains("field1\""));
        Assert.assertTrue(res.getBody().contains("field2\""));
    ...
    public void testFlsPerfNamedEx() throws Exception {
        ...
        sw.start("with fls");
        Assert.assertEquals(HttpStatus.SC_OK, (res = rh.executeGetRequest("/deals/_search?pretty&size=1000", encodeBasicHeader("perf_named_ex", "perf_named_ex"))).getStatusCode());
        sw.stop();
        Assert.assertTrue(res.getBody().contains("field1\""));
        Assert.assertTrue(res.getBody().contains("field2\""));
        Assert.assertFalse(res.getBody().contains("field50\""));
    ...
    public void testFlsWcIn() throws Exception {
        ...
        sw.start("with fls");
        Assert.assertEquals(HttpStatus.SC_OK, (res = rh.executeGetRequest("/deals/_search?pretty&size=1000", encodeBasicHeader("perf_wc_in", "perf_wc_in"))).getStatusCode());
        sw.stop();
