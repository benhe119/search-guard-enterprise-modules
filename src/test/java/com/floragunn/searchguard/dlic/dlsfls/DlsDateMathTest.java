...
public class DlsDateMathTest extends AbstractDlsFlsTest{
    ...
    public void testDlsDateMathQuery() throws Exception {
        ...
        Assert.assertEquals(HttpStatus.SC_OK, (res = rh.executeGetRequest("/logstash/_search?pretty", encodeBasicHeader("date_math", "date_math"))).getStatusCode());
    ...
    public void testDlsDateMathQueryNotAllowed() throws Exception {
        ...
        Assert.assertEquals(HttpStatus.SC_BAD_REQUEST, (res = rh.executeGetRequest("/logstash/_search?pretty", encodeBasicHeader("date_math", "date_math"))).getStatusCode());
        System.out.println(res.getBody());
